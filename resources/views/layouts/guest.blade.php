...
<body class="bg-background-light dark:bg-background-dark min-h-screen flex flex-col font-display">
    <div
        ...
        <div
            class="flex items-center bg-white dark:bg-slate-900 p-4 pb-2 justify-between border-b border-gray-200 dark:border-slate-800">
            ...
            <h2
                class="text-[#111318] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] flex-1 text-center pr-12">
                Factory Log</h2>
        </div>
        ...
        <div class="p-6 text-center">
            <p class="text-[#616f89] dark:text-slate-500 text-xs font-medium uppercase tracking-widest">Internal Use
                Only • v2.4.0</p>
        </div>
    </div>
</body>
